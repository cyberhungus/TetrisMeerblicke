document.addEventListener('DOMContentLoaded', () => {
    ...
    function decreaseInterval() {
        intervalTime = Math.max(100, intervalTime - 50); // Decrease interval, but not below 100ms
        startInterval();
    }
    ...
    p2.draw(context1); // Draw Player 2 on Board 1
    p1.draw(context2); // Draw Player 1 on Board 2
    ...
    function gameOver() {
        ...
        gameOverMessage.innerHTML = '<p>Game Over</p><p>Start Drücken</p> <p>Press Start</p>  <p> Speed: Slow </p> <p> Geschwindigkeit: Langsam </p>';
    ...
    function restartGame(event) {
        if (event.key === 'u') {
            ...
            const gameOverMessage = document.getElementById('gameOverMessage');
            if (gameOverMessage) {
                console.log("Changing style display to none")
        ...
        //make speed high
            ...
            const gameOverMessage = document.getElementById('gameOverMessage')
            gameOverMessage.style.display = "block";
            gameOverMessage.innerHTML = '<p>Game Over</p><p>Start Drücken</p> <p>Press Start</p>  <p> Speed: High</p> <p> Geschwindigkeit: Schnell </p>';
        }
        //make speed Slow
        else if (event.key === 'o'){
            intervalTime = 1000;
